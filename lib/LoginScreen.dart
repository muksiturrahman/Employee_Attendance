              ...
              children: [
                ...
                GestureDetector(
                  onTap: ()async {
                    ...
                    if (id.isEmpty){
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Employee id is still empty!")));
                    }
                    else if(password.isEmpty){
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Password is still empty!")));
                    }
                    else {
                      ...
                      try{
                        ...
                        if(e.toString() == "RangeError (index): Invalid value: valid value range is empty: 0"){
                          setState(() {
                            error = "Employee id dose not exist";
                          });
                        }else{
                          setState(() {
